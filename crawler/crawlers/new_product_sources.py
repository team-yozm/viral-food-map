...
SOURCE_DEFINITIONS: tuple[NewProductSourceDefinition, ...] = (
    ...
    NewProductSourceDefinition(
        source_key="cu_fresh_food",
        title="CU Fresh Food",
        brand="CU",
        source_type="convenience",
        channel="Fresh Food",
        site_url="https://cu.bgfretail.com/product/product.do?category=product&depth2=4&sf=N",
        crawl_url="https://cu.bgfretail.com/product/productAjax.do",
    ...
    NewProductSourceDefinition(
        source_key="gs25_fresh_food",
        title="GS25 Fresh Food",
        brand="GS25",
        source_type="convenience",
        channel="Fresh Food",
        site_url="https://gs25.gsretail.com/gscvs/ko/products/youus-freshfood",
        crawl_url="https://gs25.gsretail.com/gscvs/ko/products/youus-freshfoodDetail-search",
        parser_type="gs25_fresh_food",
        parser_config={
            "max_pages": 2,
            "page_size": 20,
            "categories": (
    ...
    NewProductSourceDefinition(
        source_key="seven_eleven_fresh_food",
        title="세븐일레븐 Fresh Food",
        brand="세븐일레븐",
        source_type="convenience",
        channel="Fresh Food",
        site_url="https://www.7-eleven.co.kr/product/bestdosirakList.asp",
        crawl_url="https://www.7-eleven.co.kr/product/dosirakNewMoreAjax.asp",
    ...
    NewProductSourceDefinition(
        source_key="kyochon_event_list",
        title="교촌치킨 신메뉴 이벤트",
        brand="교촌치킨",
        source_type="franchise",
        channel="이벤트",
        site_url="https://www.kyochon.com",
        crawl_url="https://www.kyochon.com/event/ing.asp",
        parser_type="html_media_event_list",
        parser_config={
            "item_selector": ".eventList > li",
            "detail_link_selector": "dl dt a[href], p.img a[href]",
            "title_selector": "dl dt",
            "date_selector": "dl dd",
            "image_selector": "p.img img",
            "date_format": "dash",
            "default_category": "이벤트",
            "summary_fallback": "{brand} 공식 이벤트",
            "max_items": 40,
        },
        discovery_metadata=build_source_taxonomy("chicken"),
    ),
    NewProductSourceDefinition(
        source_key="bhc_new_menu",
        title="BHC 신메뉴",
        brand="BHC",
        source_type="franchise",
        channel="메뉴",
        site_url="https://www.bhc.co.kr/menu/22",
        crawl_url="https://www.bhc.co.kr/menu/22",
        parser_type="json_product_feed",
        parser_config={
            "endpoint_url": "https://www.bhc.co.kr/api/v1/web/categories/22/products",
            "http_method": "GET",
            "list_path": "body",
            "id_field": "productCd",
            "name_field": "productNm",
            "summary_field": "description",
            "image_field": "mainImg",
            "new_flag_field": "isNew",
            "new_flag_value": "Y",
            "limited_flag_field": "isLimited",
            "limited_flag_value": "Y",
            "product_url_template": "https://www.bhc.co.kr/menu/22",
            "default_category": "치킨 신메뉴",
            "summary_fallback": "{brand} 공식 신메뉴",
    ...
    NewProductSourceDefinition(
        source_key="bhc_event_feed",
        title="BHC 이벤트",
        brand="BHC",
        source_type="franchise",
        channel="이벤트",
        site_url="https://www.bhc.co.kr",
        crawl_url="https://www.bhc.co.kr/event/currentEvent",
        parser_type="json_event_feed",
        parser_config={
            "endpoint_url": "https://www.bhc.co.kr/api/v1/web/events/list",
            "http_method": "GET",
            "list_path": "body",
            "id_field": "eventIdx",
            "title_field": "eventNm",
            ...
            "start_date_format": "iso_datetime",
            "end_date_format": "iso_datetime",
            "detail_url_template": "https://www.bhc.co.kr/event/currentEvent/{external_id}",
            "default_category": "이벤트",
            "summary_fallback": "{brand} 공식 이벤트",
    ...
    NewProductSourceDefinition(
        source_key="pizzahut_event_feed",
        title="피자헛 신메뉴 이벤트",
        brand="피자헛",
        source_type="franchise",
        channel="이벤트",
        site_url="https://www.pizzahut.co.kr",
        crawl_url="https://www.pizzahut.co.kr/cs/event",
        parser_type="json_event_feed",
        parser_config={
            "endpoint_url": "https://www.pizzahut.co.kr/api/event",
            "http_method": "GET",
            "id_field": "id",
            "title_field": "title",
            "image_field": "pc_bannerUrl",
            "fallback_image_field": "mobile_bannerUrl",
            "start_date_field": "begindate",
            "end_date_field": "enddate",
            "start_date_format": "compact",
            "end_date_format": "compact",
            "detail_url_template": "https://www.pizzahut.co.kr/cs/event",
            "default_category": "신메뉴 이벤트",
            "summary_fallback": "{brand} 공식 신메뉴 이벤트",
            "allow_food_names_without_keyword": True,
    ...
    NewProductSourceDefinition(
        source_key="bbq_event_feed",
        title="BBQ 이벤트",
        brand="BBQ",
        source_type="franchise",
        channel="이벤트",
        site_url="https://bbq.co.kr",
        crawl_url="https://bbq.co.kr/events",
        parser_type="json_event_feed",
        parser_config={
            "endpoint_url": "https://bbq.co.kr/api/delivery/content/event?searchType=OPEN&page=1&size=20",
            "http_method": "GET",
            "list_path": "content",
            "id_field": "id",
            "title_field": "title",
            ...
            "start_date_field": "startDate",
            "end_date_field": "endDate",
            "start_date_format": "dash",
            "end_date_format": "dash",
            "detail_url_template": "https://bbq.co.kr/events/{external_id}",
            "default_category": "이벤트",
            "summary_fallback": "{brand} 공식 이벤트",
            "allow_food_names_without_keyword": True,
            "short_name_max_length": 36,
            "name_hint_keywords": (
                "치킨",
                "피자",
                "버거",
    ...
    NewProductSourceDefinition(
        source_key="mrpizza_new_menu",
        title="미스터피자 신메뉴",
        brand="미스터피자",
        source_type="franchise",
        channel="메뉴",
        site_url="https://www.mrpizza.co.kr",
        crawl_url="https://www.mrpizza.co.kr/index.php",
        parser_type="html_badge_menu",
        parser_config={
            "scan_limit": 30,
            "item_selector": "#atc02 li.swiper-slide",
            "badge_selector": ".op.new img",
            "badge_text": "신메뉴",
            "detail_link_selector": "a[href]",
            "external_id_pattern": r"wr_id=(\d+)",
            "title_selector": ".info span",
            "image_style_selector": ".img",
            "default_category": "피자",
            "summary_fallback": "{brand} 공식 신메뉴",
            "max_items": 20,
        },
    ...
    NewProductSourceDefinition(
        source_key="twozzim_news",
        title="두찜 공지&이벤트",
        brand="두찜",
        source_type="franchise",
        channel="소식",
        site_url="https://www.twozzim.com/",
        crawl_url="https://www.twozzim.com/bbs/board.php?bo_table=news",
        parser_type="html_visual_news_cards",
        parser_config={
            "item_selector": ".swiper-slide-ga",
        ...
        discovery_metadata=build_source_taxonomy("other"),
    ),
    NewProductSourceDefinition(
    ...
    NewProductSourceDefinition(
        source_key="hollys_event_list",
        title="할리스 이벤트",
        brand="할리스",
        source_type="franchise",
        channel="이벤트",
        site_url="https://www.hollys.co.kr",
        crawl_url="https://www.hollys.co.kr/news/event/list.do",
        parser_type="html_event_card_list",
        parser_config={
            "item_selector": ".event_listBox",
            "title_selector": ".event_list dt",
            "date_selector": ".event_date",
            "date_format": "dash",
            "image_selector": "a img",
            "onclick_pattern": r"onDetail\((?P<id>\d+)\)",
            "detail_url_template": "https://www.hollys.co.kr/news/event/view.do?idx={external_id}",
            "default_category": "이벤트",
            "summary_fallback": "{brand} 공식 이벤트",
            "max_items": 40,
            "allow_food_names_without_keyword": True,
