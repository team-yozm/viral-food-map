...
SOURCE_DEFINITIONS: tuple[NewProductSourceDefinition, ...] = (
    ...
    NewProductSourceDefinition(
        source_key="theventi_new_menu",
        title="더벤티 신메뉴",
        brand="더벤티",
        source_type="franchise",
        channel="메뉴",
        site_url="https://www.theventi.co.kr/new2022/menu/new.html",
        crawl_url="https://www.theventi.co.kr/new2022/menu/new.html",
        parser_type="html_image_menu_cards",
        parser_config={
            "item_selector": "li.item",
            "title_selector": "p",
            "image_selector": "img",
            "default_category": "카페 신메뉴",
            "summary_fallback": "{brand} 공식 신메뉴",
            "published_at_source": "asset_upload_ymd",
            "image_timestamp_pattern": r"_(\d{8})\d{6}\.",
